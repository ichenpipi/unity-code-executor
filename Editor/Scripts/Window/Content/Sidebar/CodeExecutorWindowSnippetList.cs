...
//             }
//             // 切换
//             SnippetInfo snippet = (SnippetInfo)objects.First();
//             Switch(snippet);
//         }
//
//         /// <summary>
...
//             m_SnippetListData.AddRange(CodeExecutorData.GetSnippets());
//
//             // 处理数据
...
//             SnippetInfo snippet = listItem.userData;
//             ExecuteCode(snippet.name, snippet.code, snippet.mode);
//         }
//
//         /// <summary>
//         /// 绑定条目
...
//                 return;
//             }
//             SnippetInfo snippet = m_SnippetListData[index];
//             // 应用数据
//             ListItem listItem = (ListItem)element;
//             listItem.index = index;
//             listItem.userData = snippet;
//             // 名称
//             listItem.SetText(snippet.name);
//             // 置顶
//             listItem.SetTop(snippet.top);
//             // 重命名
...
//                     {
//                         SnippetInfo snippet = snippetInfos[i];
//                         bool isLast = (i == snippetInfos.Length - 1);
//                         CodeExecutorManager.SetSnippetTop(snippet.guid, true, isLast);
//                     }
//                     break;
//                 }
...
//                         SnippetInfo snippet = snippetInfos[i];
//                         bool isLast = (i == snippetInfos.Length - 1);
//                         CodeExecutorManager.SetSnippetTop(snippet.guid, false, isLast);
//                     }
//                     break;
//                 }
